                        ...
                        >
                          ...
                          <div className="p-8 flex flex-col flex-grow">
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                              ...
                              <a 
                                href={member.glueUpUrl || member.website}
                                target="_blank"
                                rel="noopener noreferrer"
                                title="More information"
                                className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-blue-50 hover:text-blue-600 transition-all"
                              >
